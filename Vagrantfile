...
vms = {
  'manager' => {'memory' => '3072', 'cpus' => 1, 'ip' => '100', 'box' => 'devopsbox/centos-8.5', 'provision' => 'provision/ansible/manager.yaml'},
  'worker01' => {'memory' => '1536', 'cpus' => 1, 'ip' => '101', 'box' => 'devopsbox/centos-8.5','provision' => 'provision/ansible/worker01.yaml'},
